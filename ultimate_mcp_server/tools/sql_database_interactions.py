"""SQL database interaction tools for Ultimate MCP Server.
...
logger = get_logger("ultimate_mcp_server.tools.sql_database_interactions")
...
async def find_related_tables(
    ...
    try:
        ...
        async with engine.connect() as conn:
            ...
            inspector = await conn.run_sync(sqlalchemy.inspect, conn.sync_connection)  # noqa: F841
