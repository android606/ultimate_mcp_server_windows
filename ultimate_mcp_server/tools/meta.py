"""Meta tools for Ultimate MCP Server including LLM instructions on tool usage."""
...
async def get_tool_info(
    ...
    This tool provides information about the tools available in the Ultimate MCP Server.
...
async def get_llm_instructions(
    ...
    provided by the Ultimate MCP Server. It can provide general instructions or
    ...
    # Ultimate MCP Server Tool Usage Guidelines
